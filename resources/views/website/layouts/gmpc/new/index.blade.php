      ...
      <div class="row gx-0 align-items-center">
        <div class="col-lg-7 px-5 text-start">
          ...
          <div class="h-100 d-inline-flex align-items-center me-4">
            ...
            <small>Sundays - 0800 to 1100 HRS</small>
          </div>
        </div>
      ...
      <a href="index.html" class="navbar-brand d-flex align-items-center">
        <h1 class="m-0">
          <img
            ...
            src="{{ asset('assets/img/GMPC LOGO.png') }}"
            alt=""
          />GMPC
        </h1>
      </a>
  ...
  <div id="header-carousel" class="carousel slide" data-bs-ride="carousel">
    <div class="carousel-inner">
      <div class="carousel-item active">
        <img class="w-100" src="{{ asset('assets/img/home.jpg') }}" style = "height:500px" alt="Image" />
        <div class="carousel-caption">
          <div class="container">
            <div class="row">
              <div class="col-12 col-lg-6">
                <h1 class="display-3 text-light mb-4 animated slideInDown welcome-message">
      ...
      <div class="carousel-item">
        <img class="w-100" src="{{ asset('assets/img/about2.jpg') }}"  style="height:300px" alt="Image" />
        <div class="carousel-caption">
          <div class="container">
            <div class="row">
              <div class="col-12 col-lg-6">
        ...
        <div class="row g-5">
          <div class="col-lg-3 col-md-6">
            <h1 class="text-white mb-4">
              <img class="img-fluid me-3" style="height: 90px; width: 90px;" src="img/GMPC LOGO.png" alt=""/>
            </h1>
            
            <div class="d-flex pt-2">
              <a class="btn btn-square me-1" href="https://www.instagram.com/explore/locations/1017188769/garrison-methodist-presbyterian-churchfilla-chat/?hl=en"
                ><i class="fab fa-instagram"></i
              ></a>
              <a class="btn btn-square me-1" href="https://www.facebook.com/gmpcburmacamp/"
                ><i class="fab fa-facebook-f"></i
              ></a>
              <a class="btn btn-square me-1" href="https://www.youtube.com/channel/UCPHN3fnS0mbc2JcxAaTNUUw"
          ...
          <div class="col-lg-3 col-md-6">
            ...
            <p>
              <i class="fa fa-map-marker-alt me-3"></i>Burma Camp, Accra
            </p>
            <p><i class="fa fa-phone-alt me-3"></i>+233 345 67890</p>
            <p><i class="fa fa-envelope me-3"></i>gmpc@example.com</p>
          </div>
          <div class="col-lg-3 col-md-6">
        ...
        <div class="container">
          <div class="row">
            <div class="col-md-6 text-center text-md-start mb-3 mb-md-0">
              &copy; <a href="#">GMPC</a>, All Right Reserved.
            </div>
