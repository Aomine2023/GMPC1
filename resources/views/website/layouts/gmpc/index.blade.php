                                ...
                                <div class="main-video-wrap fl-wrap">
                                    <div class="video-main-cont">
                                        <div class="video-section-title fl-wrap">
                                            ...
                                            <a href="https://www.youtube.com/@officialgaftv" target="_blank"
                                                class="text-white">
                                        ...
                                        <div class="row g-4"> <!-- Added row for horizontal arrangement -->
                                            ...
                                            <div class="col-lg-3 col-md-6">
                                                <div class="video-item fl-wrap" data-url="javascript:void(0)"
                                                    ...
                                                    <div class="video-item-title text-white">
                                                        <h4>Defence Minister Cuts Sod for Infrastructural Development
                                                            Projects at Military Training Schools.</h4>
                                                        <span class="video-date"><i class="far fa-clock"></i>
                                            ...
                                            <div class="col-lg-3 col-md-6">
                                                <div class="video-item fl-wrap" data-url="javascript:void(0)"
                                                    ...
                                                    <div class="video-item-title text-white">
                                                        <h4>CAS Sees Off 12 Ab Initio and 4 Certified Instructor Pilots to
                                                            Train in USA.</h4>
                                                        <span class="video-date"><i class="far fa-clock"></i>
                                            ...
                                            <div class="col-lg-3 col-md-6">
                                                <div class="video-item fl-wrap" data-url="javascript:void(0)"
                                                    ...
                                                    <div class="video-item-title text-white">
                                                        <h4>BURIAL SERVICE FOR THE LATE AIR COMMODORE GODFRIED SACKEY PARKER
                                                        </h4>
                                                        <span class="video-date"><i class="far fa-clock"></i>
                                                            <strong>Feb 12 2024</strong></span>
                                                    </div>
            ...
            @foreach ($participant as $list)
                <div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                    <div class="team-item rounded">
                        <img class="img-fluid" src="{{ asset($list->image) }}" alt="{{ $list->participant_name }}" />
                        <div class="text-center p-4">
                            <h5>{{ $list->rank_name }}. {{ $list->participant_name }}</h5>
                            <span>{{ $list->designation }}</span> <!-- Assuming designation is available in the model -->
                        </div>
                        <div class="team-text text-center bg-white p-4">
                            <h5>{{ $list->rank_name }}. {{ $list->participant_name }}</h5>
                            <p>{{ $list->designation }}</p> <!-- Displaying designation dynamically -->
                            <div class="d-flex justify-content-center">
                                <a class="btn btn-square btn-light m-1" href="{{ $list->twitter_link }}"><i class="fab fa-twitter"></i></a>
                                <a class="btn btn-square btn-light m-1" href="{{ $list->facebook_link }}"><i class="fab fa-facebook-f"></i></a>
                                <a class="btn btn-square btn-light m-1" href="{{ $list->youtube_link }}"><i class="fab fa-youtube"></i></a>
                                <a class="btn btn-square btn-light m-1" href="{{ $list->linkedin_link }}"><i class="fab fa-linkedin-in"></i></a>
                            </div>
                        </div>
                    </div>
                </div>
