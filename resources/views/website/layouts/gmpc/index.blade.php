          ...
          <div class="col-lg-6 wow fadeInUp" data-wow-delay="0.5s">
            <div class="h-100">
              ...
              <p class="fs-5 text-primary mb-4">
                The GMPC family.  Church isn't for perfect people. It's for hurting people, for hungry people, for growing people. It doesn't matter your background, your race, your ethnicity, your lifestyle, or what you've been through. You are welcome here. This is one of the avenues members converge to fellowship during the week.
              </p>
              <h3 class="display-8 mb-6">
                Prayer Meetings
              </h3>
              <p class="fs-5 text-primary mb-4">
                The GMPC family meets every Friday evening to commit family and loved ones into the hands of God. This is one of the avenues members converge to fellowship during the week.
              </p>
          ...
          <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
            <div class="service-item rounded h-100 p-5">
              <div class="d-flex align-items-center ms-n5 mb-4">
                ...
                <h4 class="mb-0">Youth Fellowship</h4>
              </div>
              <p class="mb-4">
          ...
          <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.3s">
            <div class="service-item rounded h-100 p-5">
              <div class="d-flex align-items-center ms-n5 mb-4">
                ...
                <h4 class="mb-0">Boys & Girls Brigade</h4>
              </div>
              <p class="mb-4">
                Aliqu diam amet eos erat ipsum et lorem et sit, sed stet lorem
                sit clita duo justo erat amet
          ...
          <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.5s">
            <div class="service-item rounded h-100 p-5">
              <div class="d-flex align-items-center ms-n5 mb-4">
                ...
                <h4 class="mb-0">Men's Fellowship</h4>
              </div>
              <p class="mb-4">
                Aliqu diam amet eos erat ipsum et lorem et sit, sed stet lorem
                sit clita duo justo erat amet
          ...
          <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
            <div class="service-item rounded h-100 p-5">
              <div class="d-flex align-items-center ms-n5 mb-4">
                ...
                <h4 class="mb-0">Women's Fellowship</h4>
              </div>
              <p class="mb-4">
                Aliqu diam amet eos erat ipsum et lorem et sit, sed stet lorem
                sit clita duo justo erat amet
          ...
          <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.5s">
            <div class="service-item rounded h-100 p-5">
              <div class="d-flex align-items-center ms-n5 mb-4">
                ...
                <h4 class="mb-0">Ark Of Praise</h4>
              </div>
              <p class="mb-4">
                Aliqu diam amet eos erat ipsum et lorem et sit, sed stet lorem
                sit clita duo justo erat amet
            ...
            <div class="main-video-wrap fl-wrap">
                ...
                <div class="video-main-cont">
                    <div class="video-section-title fl-wrap">
                        ...
                        <a href="https://www.youtube.com/@officialgaftv" target="_blank" view="" all="" <i="" class="fas fa-caret-right"></a>
                    </div>
                                            <a class="video-holder vh-main fl-wrap  image-popup" style="height:500px" href="https://www.youtube.com/embed/https://www.youtube.com/watch?v=vhu7JP7doSU">
                            <iframe width="100%" height="500" src="https://www.youtube.com/embed/https://www.youtube.com/watch?v=vhu7JP7doSU">
                            </iframe>
                        </a>
                ...
                <div class="video-links-wrap ps ps--active-y">
                    <!-- video-item  -->
                                            <div class="video-item fl-wrap" data-url="javascript:void(0)" data-video-link="https://www.youtube.com/watch?v=K-6tPkm6cZA">
                            ...
                            <div class="video-item-title">
                                ...
                                <span class="video-date"><i class="far fa-clock"></i>
                                    <strong>Feb 12 2024</strong></span>
                                        ...
                                        <!--video-item end   -->
                <div class="ps__rail-x" style="left: 0px; bottom: 0px;"><div class="ps__thumb-x" tabindex="0" style="left: 0px; width: 0px;"></div></div><div class="ps__rail-y" style="top: 0px; height: 516px; right: 0px;"><div class="ps__thumb-y" tabindex="0" style="top: 0px; height: 211px;"></div></div></div>
            ...
            <div class="team-item rounded">
              ...
              <div class="team-text text-center bg-white p-4">
                ...
                <div class="d-flex justify-content-center">
                  ...
                  ></a>
                  <a class="btn btn-square btn-light m-1" href="https://www.facebook.com/gmpcburmacamp/"
     ...
     <div class="container py-5">
       <div class="row g-5">
         <div class="col-lg-6 wow fadeIn" data-wow-delay="0.3s">
           ...
           At Garrison Methodist Preby Church, we believe your best days are still out in front of you. Whether you are joining us in person or online, we invite you to experience our services and be a part of the GMPC family. The Bible says when you are planted in the house of the Lord, you will flourish. Get ready to step into a new level of your destiny!
           </p>
