            ...
            <div class="card mt-n5">
                <div class="p-4 card-body">
                    <div class="text-center">
                        ...
                        <h5 class="mb-1 fs-16">Anna Adame</h5>
                        <p class="mb-0 text-muted">Lead Designer / Developer</p>
                    </div>
                </div>
            </div>
            <!--end card-->
                ...
                <div class="card-body">
                    <div class="mb-5 d-flex align-items-center">
                        <div class="flex-grow-1">
                            <h5 class="mb-0 card-title">Complete Your Profile</h5>
                        </div>
                        <div class="flex-shrink-0">
                            <a href="javascript:void(0);" class="badge bg-light text-primary fs-12"><i class="align-bottom ri-edit-box-line me-1"></i> Edit</a>
                        </div>
                    </div>
            ...
            <div class="card">
                <div class="card-body">
                    <div class="mb-4 d-flex align-items-center">
                        <div class="flex-grow-1">
                            <h5 class="mb-0 card-title">Portfolio</h5>
                        </div>
                        <div class="flex-shrink-0">
                            <a href="javascript:void(0);" class="badge bg-light text-primary fs-12"><i class="align-bottom ri-add-fill me-1"></i> Add</a>
                        </div>
                    </div>
                    <div class="mb-3 d-flex">
                        <div class="flex-shrink-0 avatar-xs d-block me-3">
            ...
            <div class="card mt-xxl-n5">
                <div class="card-header">
                    <ul class="rounded nav nav-tabs-custom card-header-tabs border-bottom-0" role="tablist">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" data-bs-toggle="tab" href="pages-profile-settings.html#experience" role="tab">
                                <i class="far fa-envelope"></i> Experience
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" data-bs-toggle="tab" href="pages-profile-settings.html#privacy" role="tab">
                        ...
                        <div class="tab-pane" id="changePassword" role="tabpanel">
                            ...
                            <div class="mb-3 d-flex align-items-center">
                                ...
                                <div class="flex-grow-1 ms-3">
                                    <h6>iPhone 12 Pro</h6>
                                    <p class="mb-0 text-muted">Los Angeles, United States - March 16 at 2:47PM</p>
                                </div>
                                <div>
                            ...
                            <div class="mb-3 d-flex align-items-center">
                                ...
                                <div class="flex-grow-1 ms-3">
                                    ...
                                    <p class="mb-0 text-muted">Washington, United States - November 06 at 10:43AM</p>
                                </div>
                                <div>
                                    <a href="javascript:void(0);">Logout</a>
                                </div>
                            ...
                            <div class="mb-3 d-flex align-items-center">
                                ...
                                <div class="flex-grow-1 ms-3">
                                    ...
                                    <p class="mb-0 text-muted">Conneticut, United States - June 12 at 3:24PM</p>
                                </div>
                                <div>
                                    <a href="javascript:void(0);">Logout</a>
                                </div>
                            ...
                            <div class="d-flex align-items-center">
                                ...
                                <div class="flex-grow-1 ms-3">
                                    ...
                                    <p class="mb-0 text-muted">Phoenix, United States - July 26 at 8:10AM</p>
                                </div>
                                <div>
                                    <a href="javascript:void(0);">Logout</a>
                                </div>
