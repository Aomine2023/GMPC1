                    ...
                    <div class="row">
                        <div class="col-xxl-5 align-self-center">
                            <div class="py-4">
                                ...
                                <p class="mt-3 text-success fs-15">If you can not find answer to your question in our FAQ, you can always contact us or email us. We will answer you shortly!</p>
                                <div class="flex-wrap gap-2 hstack">
                                    <button type="button" class="btn btn-primary btn-label rounded-pill"><i class="align-middle ri-mail-line label-icon rounded-pill fs-16 me-2"></i> Email Us</button>
                                    <button type="button" class="btn btn-info btn-label rounded-pill"><i class="align-middle ri-twitter-line label-icon rounded-pill fs-16 me-2"></i> Send Us Tweet</button>
                                </div>
                            </div>
                        </div>
                        <div class="col-xxl-3 ms-auto">
                            <div class="pb-1 mb-n5 faq-img d-none d-xxl-block">
            ...
            <div class="row justify-content-evenly">
                    ...
                    <div class="mt-3">
                        <div class="mb-2 d-flex align-items-center">
                            <div class="flex-shrink-0 me-1">
                                <i class="align-middle ri-question-line fs-24 text-success me-1"></i>
                            </div>
                            <div class="flex-grow-1">
                                <h5 class="mb-0 fs-16 fw-semibold">General Questions</h5>
                            </div>
                        </div>
                ...
                <div class="col-lg-4">
                    <div class="mt-3">
                        <div class="mb-2 d-flex align-items-center">
                            <div class="flex-shrink-0 me-1">
                                <i class="align-middle ri-user-settings-line fs-24 text-success me-1"></i>
                            </div>
                            <div class="flex-grow-1">
                                <h5 class="mb-0 fs-16 fw-semibold">Manage Account</h5>
                            </div>
                        </div>
                ...
                <div class="col-lg-4">
                    <div class="mt-3">
                        <div class="mb-2 d-flex align-items-center">
                            <div class="flex-shrink-0 me-1">
                                <i class="align-middle ri-shield-keyhole-line fs-24 text-success me-1"></i>
                            </div>
                            <div class="flex-grow-1">
                                <h5 class="mb-0 fs-16 fw-semibold">Privacy &amp; Security</h5>
                            </div>
                        </div>
