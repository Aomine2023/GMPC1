...
<body>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        @endif
                        <form method="POST" action="{{ route('admin.otp.verify') }}" onsubmit="combineOtp()">
                            @csrf
                            <div class="row">
                                <div class="col-3">
                                    <div class="mb-3">
                            ...
                            <div class="mt-3">
                                <button type="submit" class="btn btn-success w-100">Confirm</button>
                                        ...
                                        <form method="POST" action="{{ route('admin.otp.resend') }}" id="resend-otp-form">
                                            @csrf
    ...
    <script>
        function combineOtp() {
            // Collects values from the OTP input fields (digit1, digit2, digit3, digit4)
            const otpCode = document.querySelectorAll('input[name^="digit"]');
            
            // Combine the values of the input fields into a single string
            const otpValue = Array.from(otpCode).map(input => input.value).join('');
            
            // Set the combined OTP value into the hidden input field (otp_code)
